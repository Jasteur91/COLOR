...
export function SplineStage() {
  ...
  return (
    <div className="spline-shell pointer-events-none absolute inset-0 overflow-hidden md:pointer-events-auto">
      <div
      ...
      {/* Masque le coin inférieur (branding tiers) + fusion visuelle */}
      <div
